...
torchrun --rdzv_endpoint $BEAKER_LEADER_REPLICA_HOSTNAME:$port --rdzv_id 20086 --rdzv_backend static --nnodes ${NUM_NODES} --nproc-per-node ${NUM_GPUS_PER_WORKER} --node_rank "${BEAKER_REPLICA_RANK}" ./src/scripts/train/moe_ablation/OLMoE3-abl-260219-006.py train OLMoE3-abl-260219-006 ai2/jupiter 
